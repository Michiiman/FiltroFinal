...
public class ProductoController : BaseApiController
{
    ...
    [HttpGet("ProductosSinPedidoPlus")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<IEnumerable<Object>>> ProductosSinPedidoPlus()
    {
        var entidad = await unitofwork.Productos.ProductosSinPedidoPlus();
