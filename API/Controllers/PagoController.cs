...
public class PagoController : BaseApiController
{
    ...
    //EndPoints
    [HttpGet("PagosPaypal2008")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<IEnumerable<Object>>> PagosPaypal2008()
    {
        var entidad = await unitofwork.Pagos.PagosPaypal2008();
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<IEnumerable<Object>>> MetodosPago()
    {
        var entidad = await unitofwork.Pagos.MetodosPago();
        return mapper.Map<List<Object>>(entidad);
    }
}